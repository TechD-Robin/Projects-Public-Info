...
**Using Apple iCloud for Data Syncing**  
This App uses Apple iCloud to sync your data. If you have iCloud enabled, the App will store some of your data (such as settings and usage records) in your iCloud account to sync and access it across different devices.  
...
We implement appropriate technical and organizational measures to protect your personal information from unauthorized access, alteration, or disclosure. However, please understand that no method of transmission over the internet or electronic storage can guarantee 100% security.

**Your Choices and Rights**  
You have the right to choose whether to allow the App to connect with your BLE devices. You can disable Bluetooth functionality in your device settings, which will prevent the App from interacting with your BLE devices, and some features may no longer be available.  
If Bluetooth is disabled, you will be unable to use features that require a BLE connection, essentially limiting the use of the core functionalities of the App.

**Minors**  
Our App does not knowingly collect personal information from children under the age of 13. If you are a guardian of a minor and discover that your child has provided personal information, please contact us immediately, and we will take steps to delete such information.

**Legal Compliance**  
We are committed to complying with all applicable data protection laws, including the **General Data Protection Regulation (GDPR)** in the European Union. Since our App does not collect or store any personally identifiable information, our data processing practices are in compliance with the GDPR for users in the EU.  
If you have any questions or concerns about the processing of your data, please feel free to contact us.

**Changes to This Privacy Policy**  
This Privacy Policy may be updated from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons. Whenever we update this Privacy Policy, we will post the updated version on this page with the updated date. To stay informed of any changes, we encourage you to review this Privacy Policy periodically. By continuing to use the App, you agree to accept any updates to this Privacy Policy.
